    ...
    <div className="pt-14 md:pt-24">
      <div className="container max-w-[1360px] mx-auto px-4 lg:px-0">
        <div className="w-full sm:w-10/12 lg:w-7/12 mx-auto">
          <h2     ref={(el) => animateRefs.current.push(el)} className=" font-medium text-base text-[#fa421d] pb-2">Terms</h2>
          <h2      ref={(el) => animateRefs.current.push(el)} className="ff_general_semibold text-3xl md:text-4xl lg:text-[40px] text-black font-semibold animate-bottom">
            End User License Agreement
          </h2>
          <h4     ref={(el) => animateRefs.current.push(el)} className=" lg:text-base text-sm ff_general_semibold  text-black font-bold pt-5  animate-bottom">
            Effective Date: July 21, 2024
          </h4>
          <p     ref={(el) => animateRefs.current.push(el)} className=" lg:text-base sm:text-sm text-black font-normal leading-normal animate-bottom">
          ...
          <h4     ref={(el) => animateRefs.current.push(el)} className=" lg:text-base ff_general_semibold text-sm  text-black font-bold  animate-bottom">
            1. License
          </h4>
          <p     ref={(el) => animateRefs.current.push(el)} className=" lg:text-base sm:text-sm text-black font-normal leading-normal animate-bottom">
          ...
          <h4     ref={(el) => animateRefs.current.push(el)} className="lg:text-base text-sm ff_general_semibold text-black font-bold  animate-bottom">
