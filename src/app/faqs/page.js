  ...
  return (
    ...
    <div className="pt-16 pb-12 bg-bg_img_gradient bg-cover bg-no-repeat bg-top">
      <div className="container max-w-[1360px] mx-auto px-4">
        <div className="">
          <p  className="text-[#fa421d] text-sm lg:text-base  animate-top">Help</p>
          <h2  className="text-3xl md:text-4xl lg:text-[40px] text-black font-semibold mt-2 ff_general_semibold  animate-top ">
            Common Questions
          </h2>

          <p  className="text-lg lg:text-xl font-normal text-[#4b5563] my-6  animate-top">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[16px] pt-4">
          {faqsData.map((faq, index) => (
            <div
              ...
              key={index}
              className="bg-white rounded-2xl shadow-md p-6 flex flex-col  animate-top"
            >
